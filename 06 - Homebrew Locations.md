...
|**2**|**Rain-Activated Chainmail** <br /> *Armor (Chain Shirt), uncommon (requires attunement)* <br /> This chainmail becomes +1 armor when wetted by rainfall. The chainmail must be wet, and the water must come from rain, otherwise the armor is merely standard chainmail.|
